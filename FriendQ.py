        ...
        while i <self.no_eps:
            ...
            while True:
                ...
                if done:
                    ...
                    VA = np.max(self.QA[int(new_state[1])][int(new_state[2])][int(new_state[0])])
                    VB = np.max(self.QB[int(new_state[1])][int(new_state[2])][int(new_state[0])])
...
def fig4():
    ...
    plt.title("Fig 4.b Actions in Friend Q-learning")
