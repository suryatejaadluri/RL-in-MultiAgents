...
class World1:
    ...
    def plot_grid(self):
        ...
        if len(self.players.keys()) > 0:
            ...
            for p_id in self.players:
                ...
                self.grid[player.y][player.x] = cell
    ...
    def move(self, a):
        ...
        # print('Player order is => ', player_order)
        ...
        if self.commentator:
            ...
            print('A location: ({}, {})'.format(self.players['0'].x, self.players['0'].y))
            print('B location: ({}, {})'.format(self.players['1'].x, self.players['1'].y))
            print("")
